(function ($) {
    ...
    $.fn.SO1132A12 = function (options, param, param2) {
        try {
            ...
            errorHandle(formName, '$.fn.SO1132A12', err);
        }
    };
    var methods = {
        options: function (jq) {
    ...
    var defaults = (function () {
        ...
        this.deleteType = 2;        //作廢模式:0-BillNo+Item,1-MediaBillNo,2-MediaBillNo+ServiceType 
        ...
        this.type = 2;              //0=BillNo+Item 1=MediaBillNo 2=MediaBillNo+ServiceType
    ...
    function checkCanXX(method, data, action) {
        try {
            ...
            var parameters = $.extend({}, cloneJSON(paraLoginInfo), {
                ...
                DeleteType: { type: 'integer', value: 2 },
            });
            ...
            var produceCharge = {
                ...
                ProduceCharge: {
                    ...
                    rows: [{
                        ...
                        SERVICETYPE: convertToNull(options.serviceType)
                    }]
                }
            };
