(function ($) {
    ...
    $.fn.SO1120A9 = function (method, param) {
        try {
            ...
            return this.each(function () {
                try {
                    ...
                    if (state) {
                        ...
                        $.data(this, formName, {
                            options: $.extend({}, new defaults(), new SO1120A9(), method)
                        });
                        formLoaded(this);
                    }
                }
                catch (err) {
                    errorHandle(formName, '$.fn.SO1120A9_each', err);
                }
            });
        }
        catch (err) {
            errorHandle(formName, '$.fn.SO1120A9', err);
        }
    };
    ...
    function changeMode(div, em) {
        try {
            ...
            disableChildControls(div, getControlObject(div, 'frmSO1120A9'), options.controls, flag);
        }
        catch (err) {
