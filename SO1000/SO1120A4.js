(function ($) {
    ...
    $.fn.SO1120A4 = function (method, param) {
        try {
            ...
            return this.each(function () {
                try {
                    ...
                    if (state) {
                        ...
                        $.data(this, formName, {
                            options: $.extend({}, new defaults(), new SO1120A4(), method)
                        });
                        formLoaded(this);
                    }
                }
                catch (err) {
                    errorHandle(formName, '$.fn.SO1120A4_each', err);
                }
            });
        }
        catch (err) {
            errorHandle(formName, '$.fn.SO1120A4', err);
        }
    };
    ...
    function changeMode(div, em) {
        try {
            ...
            disableChildControls(div, getControlObject(div, 'frmSO1120A4'), options.controls, flag);
        }
        catch (err) {
