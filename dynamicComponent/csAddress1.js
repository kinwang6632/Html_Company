(function ($, window, undefined) {
	...
	function setDataToScreen(self, rwSO014) {
		try {
			...
			oo.jqxPanel({ theme: options.theme, width: 724, height: 105 });
			...
			oo.jqxInput({ theme: theme, width: 50, height: hh, maxLength: 5, value: convertNullToString(rwSO014.ZIPCODE) });
			options.controls.push({ name: oo[0]['id'], type: 'jqxInput', level: level });
			...
			oo.jqxTextArea({ theme: theme, width: 230, height: 48, disabled: false });
			...
			oo.csList({
				...
				source: data, codeNoWidth: 70, width: '82%', height: hh,
				//displayValue: { CODENO: rwSO014['STRTCODE'], DESCRIPTION: rwSO014['STRTNAME'] }
			});
